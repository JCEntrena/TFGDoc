...
\footnotesize{
  \begin{thebibliography}{99} % Beamer does not support BibTeX so references must be inserted manually as below
    ...
    \bibitem[Geng et al, 2007]{geng:2007}
...
\begin{frame}
  ...
  \footnotesize{
    \begin{thebibliography}{99}
      ...
      \bibitem[Zhang et al, 2014]{zhang:2014}
