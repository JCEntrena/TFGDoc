...
que es una introducción a la homología singular sobre espacios topológicos. La segunda
...
Primero trataré la parte sobre homología singular, y después seguiré
con el problema del clique máximo.
<!---
Homología Singular.
--->
...
a partir de la definición de la homología. Una vez tengamos esto, usaremos los grupos de homología de
las esferas para obtener nuevos resultados.  
...
una serie de resultados clásicos de matemáticas.
...
isomorfismos. En la imgen podemos ver representado el 2-símplice estándar.
...
definir una aplicación que llamamos borde, que viene dada por la suma de las caras de una cadena, en la que
...
La construcción que hemos hecho verifica los siete axiomas de Eilenberg-Steenrod para la teoría de homología:
...
por l oque los grupos de homología de ambos pares coinciden.
...
que tanto sus grupos 0-esimo como n-ésimo son isomorfos a Z, y en otro caso son cero.
...
dos abiertos de dos espacios euclídeos homeomerfos, entonces dichos espacios euclídeos tienen la misma dimensión.
