...
% ****************************************************************************************************
\newcommand{\myTitle}{Introducción a la Homología Singular. Análisis y resolución del problema del clique máximo.\xspace}
...
% Singular simplex
\newcommand{\FX}[1]{F_{#1}(\X)}
\newcommand{\FY}[1]{F_{#1}(\Y)}
\newcommand{\SX}[1]{S_{#1}(\X)}
\newcommand{\SY}[1]{S_{#1}(\Y)}
...
% Redefine return in algorithm (thanks, StackOverflow)
