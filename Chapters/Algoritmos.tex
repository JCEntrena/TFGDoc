...
\textbf{espacio de soluciones}. Estos clique estarán representados por los nodos que contienen,
de forma que las soluciones serán conjuntos de la forma $\{x_0, \dots, x_p\}$, donde cada elemento
...
aunque preservaremos el tamaño de los cliques como factor principal, pues queremos maximizarlo.
...
en una solución, y una función que nos dice si tenemos una solución. Este tipo de algoritmos suelen
ser irreversibles, esto es, no pueden deshacer elecciones ya hechas. No obstante, existen varios tipos
de algoritmos \textit{greedy}, en los que esta condición se relaja. Así, distinguiremos entre algoritmos
\textit{greedy} puros, relajados y ortogonales. En este trabajo se han implementado dos algoritmos
\textit{greedy}, uno puro y otro relajado.
...
de forma indefinida hasta que se alcance el criterio de parada.
...
partida mediante un \textbf{operador de vecindad}, a las que llamaremos \textbf{soluciones vecinas}.
...
para tratar de escapar de óptimos locales. Esto nos llevaría a una búsqueda en
entornos variables (VNS) o, nuevamente, a una búsqueda tabú, entre otras técnicas.
...
Es posible combinar este algoritmo con otros, ya sea para tratar de mejorar soluciones obtenidas
por otros, como podíra ser un \textit{greedy}, o combinarlo con otras técnicas como algoritmos
...
técnicas. Para evaluar su funcionamiento por separado, tomaremos como clique inicial
el clique vacío.
...
una función de probabilidad que decida si se acepta un movimiento a una solución de
menos calidad. Esta probabilidad vendrá dada por el algoritmo de Metrópolis, e irá
...
multiplicar la temperatura por una constante menor que $1$ en cada iteración, aunque
...
cliques. He utilizado los mismos tres operadores, \textit{add, swap} y \textit{drop},
pero en este caso, he permitido añadir cualquier nodo al grafo o intercambiar dos nodos
cualesquiera, sin necesidad de que el resultado sea un clique. La exploración del nuevo
entorno se hace igual que en el caso anterior, de forma aleatoria.
...
\autoref{enfriamiento1} \autoref{enfriamiento2}, en los que la temperatura se multiplica
