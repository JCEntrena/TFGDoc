...
En esta capítulo, introduciremos la \textbf{homología singular} de un espacio topológico. Comenzaremos con
un conjunto de  definiciones iniciales, llegando a la noción de \textbf{símplice singular}. Una vez aquí
