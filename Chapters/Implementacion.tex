...
\begin{itemize}
  ...
  \item \textit{swap}: Operador \swap}. Recibe un clique, un vértice $v$ del conjunto
  ...
  \item \textit{swap_two}: Operador \textit{swap}. En este caso, se pasan como parámetros
  ...
  \item \textit{is_connected}: Recibe un nodo $n$, un conjunto de nodos $S$ y una matriz
  ...
  \item \textit{is_connected_but_one}: Funciona igual que el anterior, pero comprueba
