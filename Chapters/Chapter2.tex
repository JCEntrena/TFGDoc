...
\begin{theorem}[Teorema de homología]
  ...
  \end{tikzcd} \]
  donde $h_2 \circ f = f' \circ h_1, h_3 \circ g = g' \circ h_2$, con $h_i$ aplicaciones de cadenas.

  Y por ello, el diagrama inducido en la homología es conmutativo.
\end{theorem}
...
\begin{proof}
  ...
  Por exactitud, deducimos que $H_1(S^1) \cong \Img \Delta = \Ker G$.
